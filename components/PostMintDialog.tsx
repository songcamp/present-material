...
export default function PostMintDialog({ colorScheme, publicTxnLoadingStatus, publicTxnSuccessStatus, publicTxnHashLink, editionAddress}) {
    ...
    const ediitionAddressLookup = editionAddress ? editionAddress : ""
                        ...
                        <Dialog.Panel className="w-fit transform overflow-hidden bg-black align-middletransition-all shadow-[0_0px_30px_10px_rgba(0,0,0,1)]" >
                            <div className="border-white border-4 border-solid my-2 overflow-hidden rounded-none shadow-lg">
                                <div className="px-8 py-4">
                                    ...
                                    <div className="text-2xl mb-5">
                                        <a 
                                            href={"https://testnet.create.zora.co/editions/" + ediitionAddressLookup}
                                            className={` hover:text-[${colorScheme}]`} style={{ textDecoration: "underline" }}>
                                            See Your Collection ➝ 
                                        </a>
                                    </div>
                                    <button                                    
